                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row no-gutters align-items-center w-100">
                                <div class="col-sm-6">
                                    <h4>Editar Provincia o Distrito</h4>
                                </div>
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('provincia_distrito.update') }}" class="needs-validation"
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mr-3">
                                            ...
                                            <select name="estado" class="form-control" required>
                                                <option value="1" {{ $provincia->estado == 1 ? 'selected' : '' }}>
                                                    Activo
                                                </option>
                                                <option value="0" {{ $provincia->estado == 0 ? 'selected' : '' }}>
                                                    Inactivo
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group pt-2">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="departamento_id" value="{{ $provincia->departamento_id }}"
                                        readonly />
                                    <input type="hidden" name="id" value="{{ $provincia->provincia_distrito_id }}"
                                        readonly />
