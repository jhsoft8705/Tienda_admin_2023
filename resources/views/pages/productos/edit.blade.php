            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('productos.update') }}" class="needs-validation" novalidate enctype="multipart/form-data">                    
                          
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" name="nombre" class="form-control" value="{{ $producto->nombre }}" maxlength="99" required>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="descripcion" class="form-control" maxlength="199">{{ $producto->descripcion }}</textarea>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-2">
                                    <div class="form-group  mr-3">
                                        <label>Precio:</label>
                                        <input type="number" name="precio" class="form-control" placeholder="0.00" step="0.01" value="{{ $producto->precio }}" required>
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group mr-3">
                                        ...
                                        <input type="number" name="precio_oferta" class="form-control" placeholder="0.00" step="0.01" value="{{ $producto->precio_oferta }}" required>
                                        <div class="invalid-feedback">Por favor ingrese un precio valido</div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group mr-3">
                                        ...
                                        <select name="estado" class="form-control" required>
                                            <option value="1" {{ $producto->estado == 0 ? 'selected' : '' }}>Activo</option>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <select name="estado_stock" class="form-control" required>
                                            <option value="1" {{ $producto->estado_stock == 1 ? 'selected' : '' }}>En Stock</option>
                                            <option value="0" {{ $producto->estado_stock == 0 ? 'selected' : '' }}>Sin Stock</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm">
                                    <div class="form-group mr-3">
                                        ...
                                        <select id="estado_oferta" name="estado_oferta" class="form-control" required>
                                            <option value="0" {{ $producto->estado_oferta == 0 ? 'selected' : '' }}>Precio Normal</option>
                                            <option value="1" {{ $producto->estado_oferta == 1 ? 'selected' : '' }}>En Oferta</option>
                                            <option value="2" {{ $producto->estado_oferta == 2 ? 'selected' : '' }}>En Oferta por Tiempo Limitado</option>
                                        </select>
                                    </div>
                                </div>
                                <div id="tiempo_div" class="col-sm {{ $producto->estado_oferta == 2? '':'d-none'}}">
                                    <div  class="form-group mr-3">
                                        <label>Valida hasta:</label>
                                        <input type="datetime-local" id="tiempo" name="tiempo" min="{{ $tiempo ? $tiempo : ''}}" value="{{ $tiempo ? $tiempo : ''}}" class="form-control" {{ $tiempo ? 'required' : ''}}>
                                        <div class="invalid-feedback">Por favor ingrese un tiempo valido</div>
                                        </div>
                                </div>

                                <div id="imagen_tiempo_div" class="col-sm {{ $producto->estado_oferta == 2? '':'d-none'}} mt-3">
                                    <div class="form-check my-6 d-flex align-items-center">
                                        <input class="form-check-input check-box" type="checkbox" value="" name="imagenTiempoCheck" id="imagenTiempoCheck" onchange="mostrarImagenTiempo(this)" {{ $producto->estado_mostrar_inicio_oferta == 0? '':'checked'}}>
                                        <label class="form-check-label label-check-box pr-1" for="imagenTiempoCheck">
                                          Mostrar oferta por tiempo
                                        </label>
                                        <a id="btn_edit_imagen_tiempo" class="btn btn_primary p-0 {{ $producto->estado_mostrar_inicio_oferta == 1? '':'d-none'}}" data-target="#imagenTiempoModal" data-toggle="modal" href="#imagenTiempoModal"><span class="material-icons">
                                            edit
                                            </span></a>
                                      </div>
                                </div>
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="form-group" style="flex-basis: 100%">
                                            ...
                                            <select name="sub_categoria_producto_id" id="sub_categoria_producto_id" class="form-control" required>
                                                ...
                                                <option value="{{ $subcategoria->sub_categoria_producto_id }}" {{ $producto->sub_categoria_producto_id == $subcategoria->sub_categoria_producto_id ? 'selected' : '' }}>{{ $subcategoria->nombre }}</option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="col-sm-6 d-flex">
                                    <div class="form-group" style="flex-basis: 100%">
                                        ...
                                        <select name="marca_producto_id" id="marca_producto_id" class="form-control" required>
                                            ...
                                            <option value="{{ $marca->marca_producto_id }}" {{ $producto->marca_producto_id == $marca->marca_producto_id ? 'selected' : '' }}>{{ $marca->nombre }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group row pt-4">
                                ...
                                <input type="hidden" name="producto_id" value="{{ $producto->producto_id }}" readonly/>
                                    ...
                                    <div class="col-sm">
                                          ...
                                          <div class="form-check my-6 d-flex align-items-center">
                                            <input class="form-check-input check-box" type="checkbox" value="" name="imagenCheck" id="imagenCheck" onchange="mostrarImagen(this)" {{ $producto->estado_mostrar_inicio == 0? '':'checked'}}>
                                            <label class="form-check-label label-check-box pr-1" for="imagenCheck">
                                              Mostrar producto en banner
                                            </label>
                                            <a id="btn_edit_imagen" class="btn btn_primary p-0 {{ $producto->estado_mostrar_inicio == 1? '':'d-none'}}" data-target="#imagenModal" data-toggle="modal" href="#imagenModal"><span class="material-icons">
                                                edit
                                                </span></a>
                                          </div>
                                    </div>
        ...
        <div class="modal-body">                  
                <div class="row no-gutters align-items-center">
                    <div class="col-sm-4">
                        <div class="form-group mr-3">
                            <label>Imagen</label>
                            <div><img class="preview" id="preview2" src="{{ $producto->imagen_inicio_oferta ? asset('producto_banner_inicio/'.$producto->imagen_inicio_oferta) : asset('assets/img/image-preview.jpg') }}" alt="your image" title=''/></div> 
                ...
                <div class="row no-gutters align-items-center">
                    <div class="col-sm-4">
                        <div class="form-group mr-3">
                            ...
                            <div id='img_container'><img class="preview" id="preview1" src="{{ $producto->imagen_inicio ? asset('producto_banner/'.$producto->imagen_inicio) : asset('assets/img/image-preview.jpg') }}" alt="your image" title=''/></div> 
                                <div class="input-group"> 
                                <div class="custom-file files form-group">
                    ...
                    <div class="col-sm-8" >
                        <div class="form-group w-100">
                            ...
                            <select name="orden_imagen" id="orden_imagen" class="form-control">
                                <option value="1" {{ $producto->order_imagen == 1 ? 'selected' : ''}}>Imagen 1 - {{ ($productos_imagenes->slice(0,1)->first()) ? $productos_imagenes->slice(0,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="2" {{ $producto->order_imagen == 2 ? 'selected' : ''}}>Imagen 2 - {{ ($productos_imagenes->slice(1,1)->first()) ? $productos_imagenes->slice(1,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="3" {{ $producto->order_imagen == 3 ? 'selected' : ''}}>Imagen 3 - {{ ($productos_imagenes->slice(2,1)->first()) ? $productos_imagenes->slice(2,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="4" {{ $producto->order_imagen == 4 ? 'selected' : ''}}>Imagen 4 - {{ ($productos_imagenes->slice(3,1)->first()) ? $productos_imagenes->slice(3,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="5" {{ $producto->order_imagen == 5 ? 'selected' : ''}}>Imagen 5 - {{ ($productos_imagenes->slice(4,1)->first()) ? $productos_imagenes->slice(4,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="6" {{ $producto->order_imagen == 6 ? 'selected' : ''}}>Imagen 6 - {{ ($productos_imagenes->slice(5,1)->first()) ? $productos_imagenes->slice(5,1)->first()->nombre : 'Vacio'}}</option>
                                <option value="7" {{ $producto->order_imagen == 7 ? 'selected' : ''}}>Imagen 7 - {{ ($productos_imagenes->slice(6,1)->first()) ? $productos_imagenes->slice(6,1)->first()->nombre : 'Vacio'}}</option>
                            </select>
...
<script>
    var imagen_inicio_cancelar = true;
    var imagen_inicio_oferta_cancelar = true;
    var productos_imagenes_json = [];
    var producto_id = parseInt('{{ $producto->producto_id }}');
    ...
    window.onload = inicializar;
     ...
     function validarImagen(){
         if($('#inputGroupFile01').val()=='' && !imagen_inicio_cancelar){
            Swal.fire({
                type: "warning",
             ...
             if(productos_imagenes_json[parseInt($('#orden_imagen').val())-1]==null || productos_imagenes_json[parseInt($('#orden_imagen').val())-1].producto_id==producto_id){
     ...
     function cancelarImagen(){
        ...
        $('#imagenModal').modal('hide');
        imagen_inicio_cancelar = false;
     }

     function validarImagenInicio(){
         if($('#inputGroupFile02').val()=='' && !imagen_inicio_oferta_cancelar){
            Swal.fire({
                type: "warning",
                title: "No selecciono una imagen",
                text: "Por favor inserte su imagen para poder continuar.",
     ...
     function cancelarImagenInicio(){
        ...
        $('#imagenTiempoModal').modal('hide');
        imagen_inicio_oferta_cancelar = false;
     }
