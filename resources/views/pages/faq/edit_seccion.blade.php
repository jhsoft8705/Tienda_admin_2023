...
<section class="section">
    <ul class="breadcrumb breadcrumb-style">
        <li class="breadcrumb-item">
            <h4 class="page-title">Seccion Preguntas Frecuentes</h4>
        </li>
    </ul>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('faq.update_seccion') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group mr-3">
                                        <label>Nombre</label>
                                        <input type="text" value="{{ $seccion->nombre }}" name="nombre" class="form-control" maxlength="99" required>
