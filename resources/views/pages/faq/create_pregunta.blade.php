                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row no-gutters align-items-center w-100">
                            <div class="col-sm-6">
                                <h4>Agregar Pregunta -> {{ $seccion->nombre }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('faq.store_pregunta') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group mr-3">
                                        ...
                                        <input type="text" name="pregunta" class="form-control" maxlength="99" required>
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group mr-3">
                                        ...
                                        <input type="text" name="respuesta" class="form-control" maxlength="99" required>
                                        <div class="invalid-feedback">Por favor ingrese un nombre valido</div>
                                        @if($errors->has('nombre'))
                                        <div class="invalid-message-feedback">{{ $errors->first('nombre') }}</div>
                                        @endif
                            ...
                            <div class="form-group pt-2">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $seccion->faq_seccion_id }}" readonly/>
