    ...
    <section class="section">
        <ul class="breadcrumb breadcrumb-style">
            <li class="breadcrumb-item">
                <h4 class="page-title">Marca de Productos</h4>
            </li>
        </ul>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('marcas_producto.update') }}" class="needs-validation"
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-sm-12">
                                        <div class="form-group mr-3">
                                            <label>Nombre</label>
                                            <input type="text" name="nombre" value="{{ $marca_producto->nombre }}"
                                ...
                                <div class="form-group pt-2">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="marca_producto_id"
                                        value="{{ $marca_producto->marca_producto_id }}" readonly />
