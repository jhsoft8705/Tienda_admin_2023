                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('metodos_de_pago.update') }}" class="needs-validation"
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col-sm-3">
                                        <div class="form-group mr-3">
                                            ...
                                            <div id='img_container'><img id="preview"
                                                    src="{{ url('/metodos_de_pago/' . ($metodo->imagen ? $metodo->imagen : 'image-preview.jpg')) }}"
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group mr-3">
                                            <label>Nombre</label>
                                            <input type="text" name="nombre" value="{{ $metodo->nombre }}"
                                            ...
                                            <input type="number" value="{{ $metodo->nro_abono }}" name="nro_abono"
                                                class="form-control" maxlength="99" required>
                                            <div class="invalid-feedback">Por favor ingrese un nro. de abono valido</div>
                                            <label>Estado</label>
                                            <select name="estado" class="form-control" required>
                                                <option value="1" {{ $metodo->estado == 1 ? 'selected' : '' }}>
                                                    Activo
                                                </option>
                                                <option value="0" {{ $metodo->estado == 0 ? 'selected' : '' }}>
                                                    Inactivo
                                                </option>
                                            </select>
                                        </div>
                                ...
                                <div class="form-group pt-2">
                                    {{ csrf_field() }}
                                    <input type="hidden" name="id" value="{{ $metodo->metodo_de_pago_id }}" readonly />
