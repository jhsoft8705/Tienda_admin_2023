                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row no-gutters align-items-center w-100">
                            <div class="col-sm-6">
                                <h4>Editar Sub Categoria // SubCategoria: {{ $subcategoria->nombre }}</h4>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('sub_categorias_producto.update') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" name="nombre" value="{{ $subcategoria->nombre }}" class="form-control" maxlength="99" required>
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="hidden" name="id" value="{{ $subcategoria->sub_categoria_producto_id }}">
