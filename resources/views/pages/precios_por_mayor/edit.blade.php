            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('precios_por_mayor.update') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-sm-12">
                                    <div class="form-group mr-3">
                                        ...
                                        <input type="number" name="cantidad" value="{{ $precio->cantidad}}" class="form-control" maxlength="99" required>
                                        <div class="invalid-feedback">Por favor ingrese una cantidad valido</div>
                                        <label>Precio</label>
                                        <input type="number" name="precio" value="{{ $precio->precio}}" class="form-control" maxlength="99" required>
                            ...
                            <div class="form-group pt-2">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $precio->precio_por_mayor_id }}" readonly/>
