...
function guardar(id) {
  ...
  data.append("id", id);
  data.append("texto_1", $("#texto1_" + id).val());
  var set1 = new Set([1, 2, 3, 4, 6, 7, 8, 10, 11]);
  var set2 = new Set([1, 4]);
  var set3 = new Set([2, 3, 4, 5, 6, 7, 8, 9, 10]);
  if (set1.has(id)) {
    data.append("texto_2", $("#texto2_" + id).val());
  }
  if (set2.has(id)) {
    data.append("texto_3", $("#texto3_" + id).val());
  }
  if (set3.has(id)) {
    data.append("texto_boton", $("#textoboton_" + id).val());
  }
  $.ajax({
    type: "post",
    url: routeName,
...
$(".save-code").on("click", function (e) {
  ...
  var currentBanner = $("#modalBannerPopup .output-banner").children(":first");
...
if ($(".banner-edit").length) {
  $(".edit-banner-4").BannerEdit({
    banner: $(".edit-banner-4").closest(".banner-edit").find(".banner.style-4"),
    text: [
      {
        input: ".edit-text-4-1",
        bnrtext: ".text-1",
  ...
  $(".edit-banner-5").BannerEdit({
    banner: $(".edit-banner-5").closest(".banner-edit").find(".banner.style-5"),
    text: [
      {
        input: ".edit-text-5-1",
        bnrtext: ".text-1",
  ...
  $(".edit-banner-6").BannerEdit({
    banner: $(".edit-banner-6").closest(".banner-edit").find(".banner.style-6"),
    text: [
      {
        input: ".edit-text-6-1",
        bnrtext: ".text-1",
  ...
  $(".edit-banner-7").BannerEdit({
    banner: $(".edit-banner-7").closest(".banner-edit").find(".banner.style-7"),
    text: [
      {
        input: ".edit-text-7-4",
        bnrtext: ".banner-btn",
  ...
  $(".edit-banner-8").BannerEdit({
    banner: $(".edit-banner-8").closest(".banner-edit").find(".banner.style-8"),
    text: [
      {
        input: ".edit-text-8-2",
        bnrtext: ".banner-btn",
